...
ctx.lineWidth = 5;
ctx.arc(x =250, y =210, r =40, startAngle =0, endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x =350, y =210, r =40, startAngle =0, endAngle);
ctx.stroke();

ctx.beginPath;
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x =210, y =40, r =40, startAngle =0, endAngle);
ctx.stroke();

ctx.beginPath;
ctx.strokeStyle = "orange";
ctx.lineWidth = 5;
ctx.arc(x =300, y =250, r =40, startAngle =0, endAngle);
ctx.stroke();

ctx.beginPath;
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc(x =400, y =250, r =40, startAngle =0, endAngle);
ctx.stroke();